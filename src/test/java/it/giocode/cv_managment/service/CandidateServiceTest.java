...
//        CandidateReqDto updateCandidateReq = CandidateReqDto.builder()
...
//        when(candidateRepository.findById(any(Long.class))).thenReturn(Optional.of(candidate));
//
//        boolean result = candidateService.updateCandidate(candidate.getCandidateId(), candidateReqDto);
//
//        assertFalse(result);
...
//        CandidateReqDto updateCandidateReq = CandidateReqDto.builder().build();
//
