...
public class UserControllerTest {
    ...
    public void userLogin_WhenServiceProcessTheLoginRequest_ShouldReturnStatus200() throws Exception {
        when(userService.userLogin(any(UserLoginReqDto.class))).thenReturn(true);
    ...
    @Test
    public void userLogin_WhenServiceProcessFailTheLoginRequest_ShouldReturnStatus500() throws Exception {
        when(userService.userLogin(any(UserLoginReqDto.class))).thenReturn(false);
